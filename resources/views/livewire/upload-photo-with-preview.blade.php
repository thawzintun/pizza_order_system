        ...
        <div class="row">
            <div class="col-3">
                ...
                @elseif (Auth::user()->profile_photo_path == null)
                    <img class="rounded mx-auto d-block img-thumbnail" src="https://ui-avatars.com/api/?name={{ Auth::user()->name }}&size=512&color=7F9CF5&background=63c76a&color=ffffff&format=svg" alt=""/>
